...
$lang = array_merge($lang, array(
	...
	'ACP_SMARTFEED_ADDITIONAL_EXPLAIN'							=> 'Adjust Smartfeed&apos;s miscellaneous settings and options',
	...
	'ACP_SMARTFEED_INCLUDE_FORUMS_EXPLAIN'						=> 'Enter the forum_ids for forums that must appear in any newsfeed. Separate the forum_ids with commas. If left blank, no forums have to be included. To determine the forum_ids, when browsing a forum observe the "f" parameter on the URL field. This is the forum_id. Example: http://www.example.com/phpBB3/viewforum.php?f=1. Do not use forum_ids that correspond to categories. Categories cannot be selected with Smartfeed.',
	...
	'ACP_SMARTFEED_RFC1766_LANG_EXPLAIN'						=> 'Language of your feed content. This is used in RSS 2.0 feeds only. <a href="http://www.w3.org/TR/REC-html40/struct/dirlang.html#langcodes">List of valid codes</a>.',
	'ACP_SMARTFEED_SECURITY'									=> 'Security settings',
	'ACP_SMARTFEED_SECURITY_EXPLAIN'							=> 'Adjust Smartfeed&apos;s security settings',
	'ACP_SMARTFEED_SETTING_SAVED'								=> 'Settings have been saved successfully!',
