...
$lang = array_merge($lang, array(
	...
	'SMARTFEED_MAX_WORD_SIZE'							=> 'Maximum words to display in a post',
	...
	'SMARTFEED_MAX_WORD_SIZE_EXPLAIN'					=> 'If zero, a post can be of any size in the feed up to the board limit, if any. Notice: if not zero, to ensure consistent rendering, if a post must be truncated, the HTML will be removed from the post. A maximum number of %d words per post is allowed.',
	'SMARTFEED_MAX_WORD_SIZE_EXPLAIN_BLANK'				=> 'If zero, a post can be of any size in the feed up to the board limit, if any. Notice: if not zero, then to ensure consistent rendering, if a post must be truncated, the HTML will be removed from the post.',
	...
	'SMARTFEED_NO_MCRYPT_SUPPORT'						=> '<b>Note: this site can provide feeds for public forums only</b>',
	...
	'SMARTFEED_NOT_LOGGED_IN'							=> '<b>Because you are not logged in or your member status does not allow it, you can only subscribe to the list of public forums shown below. Please <a href="./../../ucp.%s?mode=login" class="postlink">log in</a> or <a href="./../../ucp.%s?mode=register" class="postlink">register</a> if you want to also subscribe to nonpublic forums or to access features for registered members only.</b>',
